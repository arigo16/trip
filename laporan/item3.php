...
$d = $con->query("SELECT nik, tg_berangkat, tg_pulang, tujuan, u_saku+u_hotel+u_trans as 'akomodasi' FROM pengajuan_tb WHERE month(tg_berangkat) = '$tg1' AND year(tg_berangkat) = '$th1'");
    foreach ($d as $dd) {
