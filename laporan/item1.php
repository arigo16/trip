...
$d = $con->query("SELECT pengajuan_tb.*,karyawan_tb.nama,u_saku+u_hotel+u_trans as 'Akomodasi' FROM pengajuan_tb INNER JOIN karyawan_tb ON pengajuan_tb.nik = karyawan_tb.nik WHERE pengajuan_tb.nik = '$id' AND month(pengajuan_tb.tg_berangkat) = '$tg1' AND year(pengajuan_tb.tg_berangkat) = '$th1'");
    foreach ($d as $dd) {
