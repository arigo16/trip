...
foreach ($r as $rr) {
	$appfinance = $rr['app_finance'];
    ?>
    <div class="panel panel-default">
        <div class="panel-heading">Form User</div>
        <div class="panel-body">
            <div class="col-lg-8">
                <form class="form-horizontal" action="act/apup2.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="sts">
                                <option value="setuju" <?php if($appfinance=='setuju'){echo "selected"; } ?> >Setuju</option>
                                <option value="tidak setuju" <?php if($appfinance=='tidak setuju'){echo "selected"; } ?> >Tidak Setuju</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
